...
export default function WorkPage() {
  return <Page><PageHead title={<>Four processes.<br />No one in the loop.</>} intro="Each one used to need a person at every step. The green line on every case says where a human is still involved, and the numbers say how much runs without one." /><Work bare /><Code /><Cta /></Page>;
}
